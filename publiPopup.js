...
function ads(args) {
	...
	img.onload = function() {
		...
		css += '.' + prefix + '_div {z-index:999; position:absolute; top: 50%; margin-top:-' + img.height / 2 + 'px; left: 50%; margin-left:-' + (img.width / 2) + 'px; max-width: ' + args.width + 'px; max-height: ' + args.width + 'px;}';
